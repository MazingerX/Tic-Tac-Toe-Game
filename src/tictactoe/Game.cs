...
namespace tictactoe
{
    class Game
    {
        ...
        // replace with this definition of board to see how to declare
        // with a multi-dimentional array. You'll then need to replace
        // all [][] operators with [,] for the code to compile
        // private Square[,] _board = new Square[3,3];

        // replace with this definition of board to see how to work
        // with lists instead of arrays (but this demo is really best
        // suited to a multi-dimensional array)
